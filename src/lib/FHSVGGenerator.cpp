...
libfreehand::FHSVGGenerator::FHSVGGenerator(libfreehand::FHStringVector &vec): m_gradient(), m_style(), m_gradientIndex(1), m_patternIndex(1), m_shadowIndex(1), m_outputSink(), m_vec(vec)
{
}
...
void libfreehand::FHSVGGenerator::setStyle(const ::WPXPropertyList &propList, const ::WPXPropertyListVector &gradient)
{
  m_style.clear();
  m_style = propList;
...
void libfreehand::FHSVGGenerator::drawPolySomething(const ::WPXPropertyListVector &vertices, bool isClosed)
{
  if(vertices.count() < 2)
    return;
...
void libfreehand::FHSVGGenerator::drawGraphicObject(const ::WPXPropertyList &propList, const ::WPXBinaryData &binaryData)
{
...
void libfreehand::FHSVGGenerator::startTextObject(const ::WPXPropertyList &propList, const ::WPXPropertyListVector & /* path */)
{
...
void libfreehand::FHSVGGenerator::writeStyle(bool /* isClosed */)
{
  m_outputSink << "style=\"";
